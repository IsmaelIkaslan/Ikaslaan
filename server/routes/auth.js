...
const { users, gameStates, dbFindOne, dbInsert } = require('../db');
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    const initialPigs = [
      { id: 1, name: 'Porky', age: 0, weight: 5, quality: 'media', food: [], experience: 0, stage: 'cochinillo' },
      { id: 2, name: 'Peppa', age: 0, weight: 4, quality: 'media', food: [], experience: 0, stage: 'cochinillo' }
    ];

    await dbInsert(gameStates, {
      userId: newUser._id,
      money: 150,
      score: 0,
      level: 1,
      pigs: initialPigs,
      seeds: { acorn: 0, carrot: 0, wheat: 0 },
      updatedAt: new Date()
    });
